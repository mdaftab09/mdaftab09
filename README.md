...
`Java` · `Spring Boot` · `PostgreSQL` · `React` · `Next.js` · `Docker` · `Git` · `Cloud (AWS/GCP)`

**Exploring:** LLM-integrated backend services, applied ML, cloud security


### 📈 Currently

- Building an AI-integrated backend service (Spring Boot + LLM API + Postgres, deployed)
